...
FILE* fp;
int client_sockfd;
char msg[255] = "Client 1 user message: ";
char input[255];
...
void readInput()
{
    ...
    fprintf(fp,"Write a message to send to the server :\n");
...
int main()
{
    ...
    while (1){
        ...
        strcpy(address.sun_path, SOCKET_NAMES[SOCKET1]);
        len = sizeof(address);
        ...
        strcpy(msg , "Client 1 user message: ");
        strcpy(input, "");
